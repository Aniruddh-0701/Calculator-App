...
class _SCalci extends State<SCalci> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        // log_base
                        Expanded(child: logButton(context, 'log', b)),
                                  ...
                                  onPressed: () => setState(() {
                                    try {
                                      if (equation.last.length == 1)
                                        ...
                                        equation.last = equation.last.substring(
                                            0, equation.last.length - 1);
  ...
  Widget opButton(BuildContext context, String op) {
    final button = Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () => setState(() {
          if (op == '\u{2212}') {
            if (equation.last == '0') equation.removeLast();
          }
  ...
  addTrig(fn) {
    if (equation.length != 1 ||
        (equation.length == 1 && equation.first != '0')) {
